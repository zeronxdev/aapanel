...
Service_Add() {
    if Command_Exists systemctl ; then
        wget -t 5 -T 15 --no-check-certificate -O /usr/lib/systemd/system/btpanel.service https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/btpanel.service
...
Install_Python_Lib() {
    curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/pip_select.sh | bash
    ...
    if [ -f $pyenv_path/pyenv/bin/python ]; then
        ...
        if [ $? -eq 0 ] && [ -z "${is_ssl}" ]; then
            ...
            if [ "$is_package" = "" ]; then
                wget -T 15 --no-check-certificate -O $pyenv_path/pyenv/pip.txt https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/pip_en.txt
	...
	wget --no-check-certificate -O $pyenv_file https://github.com/zeronxdev/aapanel/releases/download/pyenv/pyenv-${os_type}${os_version}-x${is64bit}.tar.gz -T 15
        if [ "$?" != "0" ];then
    ...
    wget --no-check-certificate -O $python_src https://github.com/zeronxdev/aapanel/releases/download/python/Python-${py_version}.tar.xz -T 15
    ...
    cd ~
    rm -rf $python_src_path
    wget -T 15 --no-check-certificate -O $pyenv_path/pyenv/bin/activate https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/activate.panel
    wget -T 15 --no-check-certificate -O $pyenv_path/pyenv/pip.txt https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/pip-3.7.8.txt
...
Install_Bt() {
    ...
    wget -T 15 --no-check-certificate -O panel.zip https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/panel6_en.zip
    wget -T 15 --no-check-certificate -O /etc/init.d/bt https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/bt6_en.init
    wget -T 15 --no-check-certificate -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/public.sh
    ...
    wget -T 15 --no-check-certificate -O /etc/init.d/bt https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/bt6_en.init
    wget -T 15 --no-check-certificate -O /www/server/panel/init.sh https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/bt6_en.init
    wget --no-check-certificate -O /www/server/panel/data/softList.conf https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/softList_en.conf
}
# Other_Openssl() {
