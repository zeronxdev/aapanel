...
if [ ! -d /www/server/panel/BTPanel ];then
	...
	#echo "5.9 Smooth upgrade to 6.0 command：curl https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/update_to_6.sh|bash"
	exit 0;
fi
...
if [ "${publicFileMd5}" != "${md5check}"  ]; then
	wget -T 20 -O Tpublic.sh https://raw.githubusercontent.com/zeronxdev/aapanel/main/install/public.sh;
